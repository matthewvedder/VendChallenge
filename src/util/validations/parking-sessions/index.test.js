import { validatePhoneNumber, validateLicensePlate, validateEnterExit } from './index'
...
test('validatePhoneNumber invalid', () => {
  ...
  expect(validation).toBe('Invalid phone number length')
})
...
test('validatePhoneNumber invalid', () => {
  const errorMessage = 'License plate number must be letters, numbers, dashes, or spaces'
